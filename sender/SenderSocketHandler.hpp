...
namespace sender {
    ...
    public:
        ...
        static void onClose(ix::WebSocket &socket, std::string_view reason) {
            ...
            ui::eventStream.sendMessage("disconnected", nlohmann::json{{"reason", reason}});
        ...
        static void onMessage(ix::WebSocket &socket, std::string_view message) {
            try {
                ...
                if (type == "turn_credentials_payload") {
                    ...
                    ui::eventStream.sendMessage("join_code_issued", nlohmann::json{{"join_code", createdTransferPayload.joinCode}});

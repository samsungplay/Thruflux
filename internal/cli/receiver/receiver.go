...
func printReceiverUsage() {
	fmt.Fprintln(termio.StderrFile(), "usage: thru join <join-code> [--out DIR] [--server-url URL] [--benchmark]")
	fmt.Fprintln(termio.StderrFile(), "  --out DIR                   output directory (default .)")
	...
	fmt.Fprintln(termio.StderrFile(), "  --yes                       auto-accept transfer prompts")
	fmt.Fprintln(termio.StderrFile(), "  --no-resume                 overwrite existing data without prompting")
	fmt.Fprintln(termio.StderrFile(), "  --yes-resume                resume existing data without prompting")
